...
## Project Structure
    ...
    ├── testapiautosetting_126984  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126984`
...
2. Clone this repo and `cd testapiautosetting_126984`
